        ...
        <div className='flex flex-col gap-5 px-4'>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <div className='flex gap-5'>
                    <input  className='border-[1px] border-teal-500 text-center py-2 px-4 w-1/6' type="number" name="" id="" />

                    <button className='bg-teal-600 text-white tracking-widest font-bold px-3 py-2 rounded-md'>Add to Cart</button>
                </div>
            </div>
